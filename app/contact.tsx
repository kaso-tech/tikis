            ...
            <>
              ...
              <View style={styles.reasons}>
                {REASONS.map((item) => {
                  ...
                  return (
                    <Pressable key={item.value} accessibilityRole="button" accessibilityLabel={`Motif : ${item.label}`} onPress={() => pickReason(item.value)} style={({ pressed }) => [styles.reason, { backgroundColor: theme.surface }, active && { backgroundColor: isDark ? "#171108" : "#FFFFFF", borderWidth: 1, borderColor: isDark ? "#01A7BD" : "#E3E3E3" }, pressed && styles.pressed]}>
              ...
              <View style={[styles.inputWrap, { backgroundColor: isDark ? "#171108" : "#FFFFFF", borderColor: isDark ? "#01A7BD" : "#E3E3E3" }]}>
              ...
              <View style={[styles.inputWrap, styles.textareaWrap, { backgroundColor: isDark ? "#171108" : "#FFFFFF", borderColor: isDark ? "#01A7BD" : "#E3E3E3" }]}>
