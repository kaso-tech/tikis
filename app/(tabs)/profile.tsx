  ...
  return (
    <View style={styles.stat}>
      <View style={[styles.statIcon, color === "amber" ? styles.statIconAmber : color === "dark" ? styles.statIconDark : null]}>
        <MaterialIcons name={icon} size={16} color={color === "primary" ? "#007B8B" : color === "amber" ? "#9A6200" : "#FFFFFF"} />
      </View>
  ...
  return (
    <Pressable onPress={onPress} style={({ pressed }) => [styles.menuRow, last && styles.menuRowLast, pressed && styles.pressed]}>
      <View style={[styles.menuIcon, iconBg === "amber" ? styles.menuIconAmber : iconBg === "dark" ? styles.menuIconDark : null]}>
        <MaterialIcons name={icon} size={16} color={iconBg === "primary" ? "#007B8B" : iconBg === "amber" ? "#9A6200" : "#FFFFFF"} />
      </View>
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 80, height: 80, borderRadius: 24, backgroundColor: "#007B8B", alignItems: "center", justifyContent: "center" },
  ...
  rolePill: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 99, backgroundColor: "#E2F3F4", marginTop: 2 },
  rolePillDriver: { backgroundColor: "#FEF6E2" },
  rolePillText: { color: "#007B8B", fontSize: 10, fontWeight: "700", letterSpacing: 0.4 },
  ...
  statIcon: { width: 32, height: 32, borderRadius: 8, backgroundColor: "#E2F3F4", alignItems: "center", justifyContent: "center" },
  ...
  menuIcon: { width: 32, height: 32, borderRadius: 8, backgroundColor: "#E2F3F4", alignItems: "center", justifyContent: "center", flexShrink: 0 },
  ...
  menuBadgeSuccess: { backgroundColor: "#E2F3F4" },
  ...
  photoPicker: { flexDirection: "row", alignItems: "center", gap: 12, padding: 12, backgroundColor: "#E2F3F4", borderRadius: 10, marginTop: 14 },
  photoPickerIcon: { width: 48, height: 48, borderRadius: 12, backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center" },
  photoPickerText: { color: "#007B8B", fontSize: 12, fontWeight: "600", flex: 1 },
