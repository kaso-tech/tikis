...
const styles = StyleSheet.create({
  ...
  heroIcon: { width: 40, height: 40, borderRadius: 7, alignItems: "center", justifyContent: "center", backgroundColor: "#007B8B" },
  heroTextWrap: { flex: 1 },
  heroTitle: { color: "#FFFFFF", fontSize: 16, fontWeight: "600" },
  ...
  walletLabel: { color: "#555555", fontWeight: "500", fontSize: 13 },
  walletValue: { color: "#111111", fontWeight: "600", fontSize: 23, marginTop: 2 },
  ...
  walletLoadingText: { color: "#555555", fontSize: 12, fontWeight: "500" },
  walletUnavailable: { color: "#B4232D", fontSize: 12, fontWeight: "600", marginTop: 5 },
  walletIcon: { width: 44, height: 44, borderRadius: 8, backgroundColor: "#EEEDF3", alignItems: "center", justifyContent: "center" },
