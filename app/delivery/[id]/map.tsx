...
export default function DeliveryMapScreen() {
  ...
  if (deliveryQuery.isLoading || !delivery) return <SafeAreaView style={styles.safe}><View style={styles.center}><ActivityIndicator color="#9A6201" /><Text style={styles.loadingText}>{deliveryQuery.isLoading ? "Chargement de la carte…" : "Livraison introuvable."}</Text></View></SafeAreaView>;
  ...
  return <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
    ...
    <View style={styles.mapWrap}><DeliveryRouteMap pickup={delivery.pickup} dropoff={delivery.dropoff} coordinates={coordinates} />{isRouteLoading ? <View style={styles.routeLoading}><ActivityIndicator size="small" color="#9A6201" /><Text style={styles.routeLoadingText}>Calcul de l’itinéraire…</Text></View> : null}</View>
