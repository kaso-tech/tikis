...
export default function DeliveryDetailScreen() {
  ...
  const {
    ...
    applyToDelivery, withdrawFromDelivery, selectCandidate, confirmAssignedDelivery, completeDelivery,
  } = useTikisStore();
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
      <FlatList
        ...
        ListFooterComponent={delivery.status === "completed" && role === "sender" ? <TikisButton label="Noter le livreur" variant="ghost" icon="star-outline" onPress={() => Alert.alert("Évaluation", "Merci. L’évaluation du livreur sera enregistrée dans votre historique.")} style={styles.rateButton} /> : null}
      />
