      ...
      <FlatList
        ...
        ListHeaderComponent={<>
          ...
          <SurfaceCard style={styles.pricingCard}>
            {delivery.offeredPrice ? <><View style={styles.pricingRow}><Text style={styles.pricingLabel}>Prix proposé</Text><Text style={styles.pricingValue}>{formatMoney(delivery.offeredPrice)}</Text></View><Text style={styles.estimateReference}>Estimation intelligente : {formatMoney(delivery.estimatedPrice)}</Text></> : <View style={styles.pricingRow}><Text style={styles.pricingLabel}>Frais suggérés</Text><Text style={styles.pricingValue}>{formatMoney(delivery.estimatedPrice)}</Text></View>}
