      ...
      <FlatList
        ...
        ListHeaderComponent={<>
          ...
          <SurfaceCard style={styles.pricingCard}>
            ...
            {role === "driver" && ownCandidate?.offerPrice ? <View style={styles.counterPrice}><Text style={styles.counterPriceLabel}>Votre contre-proposition</Text><Text style={styles.counterPriceValue}>{formatMoney(ownCandidate.offerPrice)}</Text></View> : null}
