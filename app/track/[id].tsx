...
import { presentSimulatedTrackingPush } from "@/lib/simulated-push-notifications";
...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: "#F6F8FC" }, content: { padding: 20, paddingBottom: 36 }, topBar: { flexDirection: "row", alignItems: "center", marginBottom: 23 }, back: { width: 42, height: 42, borderRadius: 21, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E7ECF2", alignItems: "center", justifyContent: "center" }, heading: { flex: 1, marginLeft: 12 }, topTitle: { color: "#0B1F3A", fontSize: 16, fontWeight: "900" }, topSubtitle: { color: "#697386", fontSize: 11, marginTop: 1 }, live: { flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "#DCFCE7", paddingHorizontal: 9, height: 27, borderRadius: 14 }, liveDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: "#18A572" }, liveLabel: { color: "#147A58", fontSize: 10, fontWeight: "900", letterSpacing: 0.6 }, title: { color: "#0B1F3A", fontSize: 25, fontWeight: "900", lineHeight: 31, letterSpacing: -0.4 }, subtitle: { color: "#697386", fontSize: 14, lineHeight: 21, marginTop: 6 }, mapWrap: { marginTop: 21, shadowColor: "#0B1F3A", shadowOpacity: 0.12, shadowRadius: 18, shadowOffset: { width: 0, height: 8 }, elevation: 4 }, alert: { marginTop: 17, borderRadius: 17, padding: 13, flexDirection: "row", alignItems: "flex-start", gap: 10 }, alertNearby: { backgroundColor: "#FFF7E6", borderWidth: 1, borderColor: "#F8D89B" }, alertArrival: { backgroundColor: "#ECFBF4", borderWidth: 1, borderColor: "#BEEFD8" }, alertIcon: { width: 37, height: 37, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: "#007B8B" }, alertInfo: { flex: 1 }, alertTitle: { color: "#0B1F3A", fontSize: 14, fontWeight: "900" }, alertText: { color: "#5E6B7C", fontSize: 12, lineHeight: 18, marginTop: 2 }, alertClose: { padding: 2 }, statusCard: { marginTop: 18, flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: "#0B1F3A", borderColor: "#0B1F3A" }, statusIcon: { width: 43, height: 43, borderRadius: 14, backgroundColor: "#007B8B", alignItems: "center", justifyContent: "center" }, statusInfo: { flex: 1 }, statusTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "900" }, statusText: { color: "#BED0E7", fontSize: 12, lineHeight: 18, marginTop: 3 }, routeCard: { marginTop: 18, backgroundColor: "#FFFFFF", borderRadius: 18, padding: 15, borderWidth: 1, borderColor: "#E7ECF2" }, routeRow: { flexDirection: "row", alignItems: "center", gap: 10 }, routeIcon: { width: 32, height: 32, borderRadius: 11, alignItems: "center", justifyContent: "center" }, routeInfo: { flex: 1 }, routeLabel: { color: "#8A96A8", fontSize: 10, fontWeight: "900", letterSpacing: 0.6, textTransform: "uppercase" }, routeValue: { color: "#0B1F3A", fontSize: 13, fontWeight: "700", marginTop: 2 }, connector: { width: 1.5, height: 16, backgroundColor: "#C9D4DF", marginLeft: 15, marginVertical: 3 }, notice: { marginTop: 16, padding: 13, borderRadius: 15, backgroundColor: "#E5F6F7", flexDirection: "row", alignItems: "flex-start", gap: 9 }, noticeText: { flex: 1, color: "#35656C", fontSize: 12, lineHeight: 18 }, empty: { flex: 1, alignItems: "center", justifyContent: "center", padding: 30 }, emptyIcon: { width: 67, height: 67, borderRadius: 24, backgroundColor: "#FDEBEC", alignItems: "center", justifyContent: "center" }, emptyTitle: { color: "#0B1F3A", fontSize: 22, fontWeight: "900", marginTop: 17 }, emptyText: { color: "#697386", textAlign: "center", fontSize: 14, lineHeight: 21, marginTop: 7 }, emptyButton: { alignSelf: "stretch", marginTop: 24 }, pressed: { opacity: 0.67 },
});
