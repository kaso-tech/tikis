...
const styles = StyleSheet.create({
  ...
  textarea: { ...baseStyles.textarea, borderRadius: 10, borderWidth: 1, borderColor: "#E3E3E3", padding: 13, color: "#111111" },
