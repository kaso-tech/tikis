...
const baseStyles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: "#FAFAFA" }, keyboard: { flex: 1 }, content: { padding: 20, paddingBottom: 40 }, topBar: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 25 }, back: { width: 42, height: 42, borderRadius: 21, backgroundColor: "#FFFFFF", borderColor: "#FAFAFA", borderWidth: 1, alignItems: "center", justifyContent: "center" }, topTitle: { color: "#1F1206", fontSize: 16, fontWeight: "900" }, space: { width: 42 }, title: { color: "#1F1206", fontSize: 27, fontWeight: "900", letterSpacing: -0.4 }, subtitle: { color: "#667085", fontSize: 14, lineHeight: 21, marginTop: 8 }, label: { color: "#667085", fontSize: 11, fontWeight: "900", letterSpacing: 0.8, marginTop: 28, marginBottom: 10 }, reasons: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, reason: { paddingHorizontal: 13, paddingVertical: 10, backgroundColor: "#FFFFFF", borderRadius: 13, borderColor: "#FAFAFA", borderWidth: 1 }, reasonActive: { backgroundColor: "#FFFFFF", borderColor: "#E3E3E3" }, reasonText: { color: "#667085", fontWeight: "800", fontSize: 12 }, reasonTextActive: { color: "#9A6201" }, textarea: { minHeight: 130, backgroundColor: "#FFFFFF", borderRadius: 16, borderColor: "#E3E3E3", borderWidth: 1, padding: 14, color: "#9A6201", fontSize: 14, lineHeight: 21 }, error: { color: "#A43740", fontSize: 13, fontWeight: "800", marginTop: 8 }, attach: { marginTop: 14, padding: 13, backgroundColor: "#FAFAFA", borderRadius: 15, borderColor: "#FAFAFA", borderWidth: 1, flexDirection: "row", alignItems: "center", gap: 10 }, attachTextWrap: { flex: 1 }, attachTitle: { color: "#9A6201", fontSize: 13, fontWeight: "900" }, attachText: { color: "#9A6201", fontSize: 12, lineHeight: 17, marginTop: 2 }, attachPreview: { width: 40, height: 40, borderRadius: 8 }, attachRemove: { width: 30, height: 30, borderRadius: 15, backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center" }, submit: { marginTop: 24 }, success: { alignItems: "center", paddingTop: 58, paddingHorizontal: 15 }, successIcon: { width: 66, height: 66, borderRadius: 24, backgroundColor: "#176C52", alignItems: "center", justifyContent: "center" }, successTitle: { color: "#1F1206", fontSize: 23, fontWeight: "900", marginTop: 18 }, successText: { color: "#667085", fontSize: 14, lineHeight: 21, textAlign: "center", marginTop: 8 }, successButton: { alignSelf: "stretch", marginTop: 26 }, pressed: { opacity: 0.67 },
});

const styles = StyleSheet.create({
  ...baseStyles,
  safe: { ...baseStyles.safe, backgroundColor: "#FAFAFA" },
  ...
  attach: { ...baseStyles.attach, borderRadius: 10, borderWidth: 0, backgroundColor: "#FAFAFA", padding: 12 },
