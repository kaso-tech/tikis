...
const styles = StyleSheet.create({
  ...
  close: { width: 40, height: 40, borderRadius: 8, alignItems: "center", justifyContent: "center", backgroundColor: "#F5F5F5" },
  closeSpacer: { width: 40 },
  headerCopy: { flex: 1 },
  eyebrow: { color: "#9A6201", fontSize: 10, fontWeight: "600", letterSpacing: 0.7 },
  ...
  confirmationCard: { marginTop: 4, borderWidth: 0, backgroundColor: "#F5F5F5" },
  confirmationHeading: { flexDirection: "row", alignItems: "center", gap: 9 },
  confirmationIcon: { width: 32, height: 32, borderRadius: 8, alignItems: "center", justifyContent: "center", backgroundColor: "#F5F5F5" },
  ...
  confirmationFact: { color: "#167A55", fontSize: 10, fontWeight: "600", backgroundColor: "#F5F5F5", borderRadius: 6, overflow: "hidden", paddingHorizontal: 7, paddingVertical: 3 },
  confirmationActions: { flexDirection: "row", gap: 8, marginTop: 14 },
  confirmationAction: { flex: 1, minHeight: 42 },
  searchBox: { height: 44, flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 12, backgroundColor: "#FFFFFF", borderRadius: 9, borderWidth: 1, borderColor: "#E3E3E3", marginBottom: 12 },
  searchInput: { flex: 1, color: "#9A6201", fontSize: 14, fontWeight: "500", height: "100%" },
  clearSearch: { width: 24, height: 24, borderRadius: 6, alignItems: "center", justifyContent: "center", backgroundColor: "#FFFFFF" },
  ...
  favoriteIcon: { width: 32, height: 32, borderRadius: 7, alignItems: "center", justifyContent: "center", backgroundColor: "#F5F5F5" },
  favoriteCopy: { flex: 1 },
  ...
  manageButton: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 4, flex: 1, minHeight: 34, backgroundColor: "#F5F5F5", borderRadius: 8 },
  ...
  renameInput: { minHeight: 44, borderRadius: 9, borderWidth: 1, borderColor: "#E3E3E3", backgroundColor: "#FFFFFF", color: "#111111", fontSize: 14, fontWeight: "500", paddingHorizontal: 12, marginTop: 14 },
