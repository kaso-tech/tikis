...
export function TikisDrawer() {
  ...
  const { role, setRole, notifications } = useTikisStore();
  const unread = notifications.filter((item) => !item.read).length;
  const items = drawerItems(role, unread);
  const name = role === "sender" ? "Aïcha Traoré" : "Antoine Kaboré";
  const initials = role === "sender" ? "AT" : "AK";
...
const styles = StyleSheet.create({
  header: { height: 65, backgroundColor: "#FFFFFF", borderBottomWidth: 1, borderColor: "#E7ECF2", paddingHorizontal: 16, flexDirection: "row", alignItems: "center" }, headerIcon: { width: 43, height: 43, borderRadius: 15, alignItems: "center", justifyContent: "center", backgroundColor: "#F6F8FC", borderWidth: 1, borderColor: "#E7ECF2" }, brand: { flex: 1, flexDirection: "row", alignItems: "center", gap: 9, paddingLeft: 13 }, brandMark: { width: 31, height: 31, borderRadius: 10, alignItems: "center", justifyContent: "center", backgroundColor: "#007B8B" }, brandName: { color: "#0B1F3A", fontSize: 18, fontWeight: "900", letterSpacing: -0.4 }, brandContext: { color: "#78869A", fontSize: 10, fontWeight: "700", marginTop: -1 }, headerBadge: { position: "absolute", right: 4, top: 4, minWidth: 17, height: 17, borderRadius: 9, backgroundColor: "#C23B45", alignItems: "center", justifyContent: "center", paddingHorizontal: 3, borderWidth: 1.5, borderColor: "#FFFFFF" }, headerBadgeText: { color: "#FFFFFF", fontWeight: "900", fontSize: 9 }, drawerModal: { flex: 1, flexDirection: "row" }, scrim: { flex: 1, backgroundColor: "rgba(8,22,42,0.48)" }, drawerPanel: { width: "86%", maxWidth: 360, minHeight: "100%", backgroundColor: "#FFFFFF", paddingHorizontal: 18, paddingBottom: 20 }, drawerTop: { height: 44, alignItems: "center", flexDirection: "row", justifyContent: "space-between" }, drawerEyebrow: { color: "#8A96A8", fontSize: 10, fontWeight: "900", letterSpacing: 1 }, closeButton: { width: 38, height: 38, borderRadius: 13, alignItems: "center", justifyContent: "center", backgroundColor: "#F6F8FC" }, profileBlock: { flexDirection: "row", alignItems: "center", gap: 12, paddingTop: 15, paddingBottom: 18 }, profileText: { flex: 1 }, profileName: { color: "#0B1F3A", fontSize: 17, fontWeight: "900" }, rolePill: { flexDirection: "row", alignItems: "center", gap: 5, marginTop: 4 }, roleDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: "#18A572" }, roleLabel: { color: "#697386", fontSize: 12, fontWeight: "700" }, roleSwitch: { flexDirection: "row", gap: 8, backgroundColor: "#F2F5F8", padding: 4, borderRadius: 15 }, roleButton: { flex: 1, height: 39, borderRadius: 11, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6 }, roleButtonActive: { backgroundColor: "#007B8B" }, roleButtonText: { color: "#697386", fontSize: 12, fontWeight: "900" }, roleButtonTextActive: { color: "#FFFFFF" }, menuLabel: { color: "#8A96A8", fontSize: 10, fontWeight: "900", letterSpacing: 0.9, marginTop: 25, marginBottom: 8 }, menu: { gap: 4 }, menuRow: { minHeight: 66, borderRadius: 17, paddingHorizontal: 10, flexDirection: "row", alignItems: "center", gap: 10 }, menuRowActive: { backgroundColor: "#0B1F3A" }, menuIcon: { width: 39, height: 39, borderRadius: 13, alignItems: "center", justifyContent: "center", backgroundColor: "#E5F6F7" }, menuIconActive: { backgroundColor: "#007B8B" }, menuText: { flex: 1 }, menuTitle: { color: "#0B1F3A", fontSize: 14, fontWeight: "900" }, menuTitleActive: { color: "#FFFFFF" }, menuCaption: { color: "#8A96A8", fontSize: 11, marginTop: 2 }, menuCaptionActive: { color: "#C1D4E5" }, menuBadge: { minWidth: 21, height: 21, borderRadius: 11, backgroundColor: "#C23B45", paddingHorizontal: 5, alignItems: "center", justifyContent: "center" }, menuBadgeText: { color: "#FFFFFF", fontSize: 10, fontWeight: "900" }, drawerFooter: { marginTop: "auto", paddingTop: 18, borderTopWidth: 1, borderColor: "#E7ECF2" }, securityRow: { flexDirection: "row", alignItems: "center", gap: 7, marginBottom: 14 }, securityText: { color: "#697386", fontSize: 11, fontWeight: "700" }, signOut: { height: 46, borderRadius: 14, backgroundColor: "#FFF3F3", alignItems: "center", justifyContent: "center", gap: 8, flexDirection: "row" }, signOutText: { color: "#C23B45", fontSize: 13, fontWeight: "900" }, pressed: { opacity: 0.67 },
});
