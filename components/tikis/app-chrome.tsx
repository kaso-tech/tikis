...
const drawerItems = (role: UserRole, unread: number): DrawerItem[] => {
  const shared: DrawerItem[] = [{ key: "home", label: "Accueil", caption: "Vue d’ensemble", icon: "home-filled", route: "/(tabs)" }, { key: "deliveries", label: role === "sender" ? "Mes livraisons" : "Opportunités", caption: role === "sender" ? "Suivi de vos courses" : "Courses compatibles", icon: "local-shipping", route: "/(tabs)/deliveries" }];
  if (role === "driver") {
  ...
  return [...shared, { key: "notifications", label: "Notifications", caption: "Activité de vos courses", icon: "notifications", route: "/notifications", badge: unread }, { key: "history", label: "Historique", caption: "Courses terminées", icon: "history", route: "/history" }, { key: "reviews", label: "Mes avis", caption: role === "driver" ? "Évaluations reçues" : "Évaluations envoyées", icon: "star-outline", route: "/reviews" }, { key: "profile", label: "Profil et préférences", caption: "Compte, rôle et assistance", icon: "person", route: "/(tabs)/profile" }];
};
...
const styles = StyleSheet.create({
  ...
  drawerPanel: { width: "100%", maxWidth: 380, minHeight: "100%", backgroundColor: "#FFFFFF", paddingHorizontal: 16, paddingBottom: 16 },
  drawerTop: { height: 42, alignItems: "center", flexDirection: "row", justifyContent: "space-between" },
  drawerEyebrow: { color: "#747474", fontSize: 10, fontWeight: "600", letterSpacing: 0.9 },
  closeButton: { width: 36, height: 36, borderRadius: 8, alignItems: "center", justifyContent: "center", backgroundColor: "#EEEDF3" },
  profileBlock: { flexDirection: "row", alignItems: "center", gap: 10, paddingTop: 13, paddingBottom: 12 },
  profileText: { flex: 1 },
  profileName: { color: "#111111", fontSize: 16, fontWeight: "600" },
  ...
  roleLabel: { color: "#666666", fontSize: 12, fontWeight: "500" },
  lockedAccount: { padding: 10, backgroundColor: "#EEEDF3", borderRadius: 8, flexDirection: "row", alignItems: "center", gap: 8 },
  lockedAccountText: { color: "#444444", fontSize: 12, fontWeight: "500", flex: 1 },
  menuLabel: { color: "#747474", fontSize: 10, fontWeight: "600", letterSpacing: 0.9, marginTop: 20, marginBottom: 6 },
  menu: { gap: 2 },
  menuRow: { minHeight: 60, borderRadius: 8, paddingHorizontal: 9, flexDirection: "row", alignItems: "center", gap: 9 },
  menuRowActive: { backgroundColor: "#111111" },
  menuIcon: { width: 36, height: 36, borderRadius: 8, alignItems: "center", justifyContent: "center", backgroundColor: "#EEEDF3" },
  menuIconActive: { backgroundColor: "#007B8B" },
  menuText: { flex: 1 },
  menuTitle: { color: "#111111", fontSize: 14, fontWeight: "600" },
  ...
  securityRow: { flexDirection: "row", alignItems: "center", gap: 7, marginBottom: 12 },
  securityText: { color: "#666666", fontSize: 11, fontWeight: "500" },
  signOut: { height: 44, borderRadius: 8, backgroundColor: "#F8E8E9", alignItems: "center", justifyContent: "center", gap: 8, flexDirection: "row" },
  signOutText: { color: "#B4232D", fontSize: 13, fontWeight: "600" },
