...
const styles = StyleSheet.create({
  card: { backgroundColor: "#FFFFFF", borderRadius: 12, borderWidth: 1, borderColor: "#E3E3E3", marginBottom: 9, overflow: "hidden", elevation: 0 },
  summary: { padding: 13, paddingBottom: 11 },
  pressed: { opacity: 0.76 },
  topRow: { flexDirection: "row", alignItems: "center" },
  vehicleIcon: { width: 36, height: 36, borderRadius: 9, backgroundColor: "#F1F1F1", alignItems: "center", justifyContent: "center", marginRight: 9 },
  titleWrap: { flex: 1, marginRight: 8 },
  title: { color: "#111111", fontSize: 15, fontWeight: "700" },
  when: { color: "#747474", fontSize: 11, fontWeight: "600", marginTop: 2 },
  ...
  dropoff: { color: "#111111", fontWeight: "700" },
  footer: { borderTopColor: "#ECECEC", borderTopWidth: 1, marginTop: 12, paddingTop: 9, flexDirection: "row", alignItems: "center" },
  distance: { color: "#111111", fontSize: 12, fontWeight: "700" },
  vehiclePill: { flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: "#F3F3F3", borderRadius: 6, paddingHorizontal: 7, paddingVertical: 4, marginLeft: 8 },
  vehicleText: { color: "#555555", fontSize: 10.5, fontWeight: "700" },
  price: { color: "#111111", fontSize: 15, fontWeight: "700", marginLeft: "auto" },
  candidateCount: { flexDirection: "row", alignItems: "center", gap: 2, marginLeft: 8 },
  candidateCountText: { color: "#555555", fontSize: 11, fontWeight: "700" },
  actions: { flexDirection: "row", alignItems: "center", gap: 8, borderTopWidth: 1, borderColor: "#ECECEC", padding: 9, backgroundColor: "#FFFFFF" },
  mapButton: { flex: 1, minHeight: 40, borderRadius: 8 },
  applyButton: { flex: 1.25, minHeight: 40, borderRadius: 8 },
  appliedState: { flex: 1.25, minHeight: 40, paddingHorizontal: 10, borderRadius: 8, backgroundColor: "#F3F3F3", alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 6, borderWidth: 1, borderColor: "#E3E3E3" },
  appliedStateText: { color: "#167A55", fontSize: 11, fontWeight: "700" },
