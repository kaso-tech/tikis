...
const baseStyles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: "#DDE6E2" }, map: { ...StyleSheet.absoluteFillObject }, centerMarker: { position: "absolute", top: "48%", alignSelf: "center", alignItems: "center", marginTop: -37 }, markerBubble: { width: 57, height: 57, borderRadius: 12, backgroundColor: "#007B8B", alignItems: "center", justifyContent: "center", borderWidth: 0, shadowOpacity: 0, shadowRadius: 0, elevation: 0 }, markerStem: { width: 3, height: 22, backgroundColor: "#007B8B" }, markerShadow: { width: 19, height: 7, borderRadius: 10, backgroundColor: "transparent" }, controls: { flex: 1, paddingTop: 16 }, instruction: { alignSelf: "center", color: "#17212B", fontSize: 15, fontWeight: "600", paddingHorizontal: 14, paddingVertical: 8, borderRadius: 9, backgroundColor: "rgba(255,255,255,0.92)", overflow: "hidden" }, floatingControls: { position: "absolute", left: 18, right: 18, bottom: 190, flexDirection: "row", justifyContent: "space-between" }, roundButton: { width: 54, height: 54, borderRadius: 12, backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center", shadowOpacity: 0, shadowRadius: 0, elevation: 0 }, bottomSheet: { marginTop: "auto", backgroundColor: "#FFFFFF", borderTopLeftRadius: 14, borderTopRightRadius: 14, padding: 16, paddingTop: 9, shadowOpacity: 0, shadowRadius: 0, elevation: 0 }, sheetHandle: { width: 40, height: 4, borderRadius: 3, backgroundColor: "#D5DDE6", alignSelf: "center", marginBottom: 12 }, sheetEyebrow: { color: "#007B8B", fontSize: 10, letterSpacing: 0.8, fontWeight: "600" }, placeTitle: { color: "#111111", fontSize: 18, fontWeight: "600", marginTop: 5 }, placeMeta: { color: "#6F7B89", fontSize: 12, lineHeight: 17, marginTop: 3 }, placePlaceholder: { color: "#6F7B89", fontSize: 14, marginTop: 8 }, resolving: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: 9 }, resolvingText: { color: "#657180", fontSize: 13, fontWeight: "600" }, message: { color: "#A55A00", fontSize: 11, lineHeight: 16, marginTop: 8 }, sheetActions: { flexDirection: "row", gap: 8, marginTop: 14 }, useButton: { flex: 1, minHeight: 51, borderRadius: 9 }, favoriteButton: { width: 52, minHeight: 51, borderRadius: 9, backgroundColor: "#FFF4D8", alignItems: "center", justifyContent: "center" }, pressed: { opacity: 0.62 },
});
