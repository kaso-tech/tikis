...
const styles = StyleSheet.create({
  overlay: { flex: 1, justifyContent: "flex-end", backgroundColor: "rgba(0,0,0,0.42)" }, backdrop: { ...StyleSheet.absoluteFillObject }, sheet: { height: "88%", backgroundColor: "#FFFFFF", borderTopLeftRadius: 12, borderTopRightRadius: 12, overflow: "hidden" }, dragZone: { height: 32, alignItems: "center", justifyContent: "center" }, handle: { width: 40, height: 4, borderRadius: 2, backgroundColor: "#CFCFCF" }, keyboard: { flex: 1 }, safe: { flex: 1 }, searchBox: { minHeight: 56, flexDirection: "row", alignItems: "center", marginHorizontal: 14, backgroundColor: "#FFFFFF", borderRadius: 9, borderWidth: 1, borderColor: "#E3E3E3", paddingLeft: 12, paddingRight: 6 }, input: { flex: 1, minHeight: 54, color: "#111111", fontSize: 16, paddingLeft: 10, fontWeight: "500" }, clear: { width: 28, height: 28, borderRadius: 8, alignItems: "center", justifyContent: "center", backgroundColor: "#F5F5F5", marginHorizontal: 4 }, searchDivider: { width: 1, height: 28, backgroundColor: "#CFCFCF", marginLeft: 1 }, mapTextButton: { minHeight: 44, paddingHorizontal: 14, alignItems: "center", justifyContent: "center" }, mapText: { color: "#9A6201", fontWeight: "600", fontSize: 14 }, quickActions: { paddingHorizontal: 16, paddingTop: 16, paddingBottom: 24 }, recentBlock: { marginTop: 14, paddingTop: 2 }, recentHeading: { color: "#747474", fontSize: 10, fontWeight: "600", letterSpacing: 0.7, marginBottom: 6 }, recentRow: { minHeight: 52, flexDirection: "row", alignItems: "center", gap: 9, borderBottomColor: "#ECECEC", borderBottomWidth: 1 }, recentIcon: { width: 30, height: 30, borderRadius: 7, alignItems: "center", justifyContent: "center", backgroundColor: "#F5F5F5" }, recentTitle: { color: "#111111", fontSize: 13, fontWeight: "600" }, recentMeta: { color: "#666666", fontSize: 11, marginTop: 2 }, quickAction: { minHeight: 64, flexDirection: "row", alignItems: "center", gap: 12, borderBottomColor: "#ECECEC", borderBottomWidth: 1 }, quickIcon: { width: 36, alignItems: "center" }, savedIcon: { width: 36, alignItems: "center" }, quickCopy: { flex: 1 }, quickTitle: { color: "#111111", fontSize: 15, fontWeight: "600" }, quickSubtitle: { color: "#666666", fontSize: 12, lineHeight: 17, marginTop: 2 }, resultsContent: { paddingHorizontal: 16, paddingTop: 10, paddingBottom: 30 }, loadingResults: { flexDirection: "row", alignItems: "center", gap: 8, paddingVertical: 12 }, loadingText: { color: "#666666", fontSize: 12, fontWeight: "500" }, result: { minHeight: 60, flexDirection: "row", alignItems: "center", gap: 10, borderBottomColor: "#ECECEC", borderBottomWidth: 1 }, resultIcon: { width: 36, height: 36, borderRadius: 8, backgroundColor: "#F5F5F5", alignItems: "center", justifyContent: "center" }, resultCopy: { flex: 1, minWidth: 0 }, resultName: { color: "#111111", fontSize: 14, fontWeight: "600" }, resultMeta: { color: "#666666", fontSize: 12, lineHeight: 16, marginTop: 2 }, message: { color: "#9A6201", fontSize: 12, lineHeight: 17, marginTop: 12 }, attribution: { color: "#666666", fontSize: 10, marginTop: 9 }, addressBack: { flexDirection: "row", alignItems: "center", gap: 5, minHeight: 30, alignSelf: "flex-start", marginBottom: 7 }, addressBackText: { color: "#9A6201", fontSize: 12, fontWeight: "600" }, addressesTitle: { color: "#111111", fontSize: 20, fontWeight: "600", marginBottom: 8 }, savedRow: { flexDirection: "row", alignItems: "center", minHeight: 60, gap: 10, borderBottomColor: "#ECECEC", borderBottomWidth: 1 }, savedRowIcon: { width: 34, height: 34, borderRadius: 8, backgroundColor: "#F5F5F5", alignItems: "center", justifyContent: "center" }, savedRowCopy: { flex: 1 }, savedRowTitle: { color: "#111111", fontSize: 14, fontWeight: "600" }, savedRowMeta: { color: "#666666", fontSize: 11, lineHeight: 15, marginTop: 2 }, empty: { alignItems: "center", paddingHorizontal: 28, paddingTop: 36 }, emptyTitle: { color: "#111111", fontSize: 15, fontWeight: "600", marginTop: 9 }, emptyText: { color: "#666666", textAlign: "center", fontSize: 12, lineHeight: 17, marginTop: 5 }, pressed: { opacity: 0.67 },
});
