...
export function YangoAddressPicker({ visible, target, value, countryCode, favorites, onClose, onSelect, onFavorite }: { visible: boolean; target: LocationTarget | null; value: LocationLabel | null; countryCode?: string; favorites: SavedFavorite[]; onClose: () => void; onSelect: (place: LocationLabel) => void; onFavorite: (place: LocationLabel) => Promise<void> }) {
  ...
  function selectSavedAddress(place: LocationLabel) { onSelect(place); onClose(); }
