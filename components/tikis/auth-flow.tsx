...
const baseStyles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: "#F5F5F5" }, keyboard: { flex: 1 }, scroll: { flexGrow: 1, padding: 20, paddingBottom: 35 }, welcome: { flex: 1, justifyContent: "space-between" }, brandArea: { alignItems: "center", paddingTop: 18 }, logo: { width: 88, height: 88, borderRadius: 26 }, brandChip: { flexDirection: "row", alignItems: "center", gap: 6, borderRadius: 12, paddingHorizontal: 10, height: 28, backgroundColor: "#F5F5F5", marginTop: 12 }, brandStatus: { width: 6, height: 6, borderRadius: 3, backgroundColor: "#18A572" }, brandChipText: { color: "#9A6201", fontSize: 10, fontWeight: "900", letterSpacing: 0.45 }, welcomeBody: { marginTop: 30 }, welcomeEyebrow: { color: "#9A6201", fontSize: 13, fontWeight: "900", textTransform: "uppercase", letterSpacing: 0.7 }, welcomeTitle: { color: "#1F1206", fontSize: 33, lineHeight: 40, fontWeight: "900", letterSpacing: -0.7, marginTop: 8 }, welcomeSubtitle: { color: "#667085", fontSize: 15, lineHeight: 23, marginTop: 10 }, languageLabel: { color: "#667085", fontSize: 11, fontWeight: "900", letterSpacing: 0.8, marginTop: 25, marginBottom: 8 }, languageSwitch: { flexDirection: "row", borderRadius: 15, backgroundColor: "#F5F5F5", padding: 4, gap: 4 }, languageOption: { flex: 1, height: 42, borderRadius: 11, alignItems: "center", justifyContent: "center" }, languageActive: { backgroundColor: "#FFFFFF", shadowOpacity: 0, shadowRadius: 0, elevation: 0 }, languageText: { color: "#667085", fontSize: 13, fontWeight: "900" }, languageTextActive: { color: "#9A6201" }, trustList: { marginTop: 23, gap: 10 }, trustRow: { flexDirection: "row", gap: 10, padding: 12, backgroundColor: "#FFFFFF", borderRadius: 16, borderWidth: 1, borderColor: "#F5F5F5" }, trustIcon: { width: 36, height: 36, borderRadius: 12, backgroundColor: "#F5F5F5", alignItems: "center", justifyContent: "center" }, trustInfo: { flex: 1 }, trustTitle: { color: "#1F1206", fontSize: 13, fontWeight: "900" }, trustText: { color: "#667085", fontSize: 12, lineHeight: 17, marginTop: 2 }, welcomeButton: { marginTop: 25 }, legal: { color: "#667085", fontSize: 11, lineHeight: 17, textAlign: "center", marginTop: 14, paddingHorizontal: 12 }, legalLink: { color: "#9A6201", fontWeight: "900" }, top: { height: 49, flexDirection: "row", alignItems: "center", marginBottom: 25 }, backButton: { width: 42, height: 42, borderRadius: 15, backgroundColor: "#FFFFFF", borderColor: "#F5F5F5", borderWidth: 1, alignItems: "center", justifyContent: "center" }, stepInfo: { flex: 1, marginLeft: 10 }, stepLabel: { color: "#9A6201", fontSize: 10, fontWeight: "900", letterSpacing: 0.8 }, stepCount: { color: "#1F1206", fontSize: 13, fontWeight: "900", marginTop: 2 }, stepDots: { flexDirection: "row", gap: 4 }, stepDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: "#F5F5F5" }, stepDotActive: { backgroundColor: "#9A6201" }, form: { flex: 1, paddingTop: 5 }, heroIcon: { width: 64, height: 64, borderRadius: 22, alignItems: "center", justifyContent: "center", backgroundColor: "#F5F5F5", marginBottom: 20 }, title: { color: "#1F1206", fontSize: 28, lineHeight: 34, fontWeight: "900", letterSpacing: -0.5 }, subtitle: { color: "#667085", fontSize: 14, lineHeight: 21, marginTop: 8 }, fieldLabel: { color: "#667085", fontSize: 11, fontWeight: "900", letterSpacing: 0.75, marginTop: 25, marginBottom: 8 }, countryField: { minHeight: 60, borderRadius: 16, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", backgroundColor: "#FFFFFF", borderColor: "#E3E3E3", borderWidth: 1 }, countryBadge: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: "#FFFFFF" }, countryFlag: { color: "#9A6201", fontWeight: "900", fontSize: 11 }, countryInfo: { flex: 1, marginLeft: 10 }, countryName: { color: "#9A6201", fontSize: 14, fontWeight: "900" }, countryHint: { color: "#667085", fontSize: 11, marginTop: 2 }, phoneField: { height: 58, borderRadius: 16, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E3E3E3", flexDirection: "row", alignItems: "center", paddingHorizontal: 14 }, fieldError: { borderColor: "#E45858" }, dialCode: { paddingRight: 12, borderRightWidth: 1, borderColor: "#F5F5F5" }, dialCodeText: { color: "#9A6201", fontWeight: "900", fontSize: 15 }, phoneInput: { flex: 1, color: "#9A6201", fontSize: 17, fontWeight: "800", marginLeft: 12, letterSpacing: 0.5 }, helper: { color: "#667085", fontSize: 12, lineHeight: 18, marginTop: 8 }, error: { color: "#A43740", fontSize: 12, lineHeight: 18, marginTop: 8, fontWeight: "700" }, actionButton: { marginTop: 25 }, simulationNotice: { flexDirection: "row", gap: 9, padding: 12, borderRadius: 15, backgroundColor: "#F5F5F5", marginTop: 22 }, simulationText: { flex: 1, color: "#9A6201", fontSize: 12, lineHeight: 18 }, simulationCode: { color: "#9A6201", fontWeight: "900" }, phoneHighlight: { color: "#9A6201", fontWeight: "900" }, otpRow: { flexDirection: "row", justifyContent: "space-between", gap: 8, marginTop: 27 }, otpInput: { flex: 1, height: 54, backgroundColor: "#FFFFFF", borderRadius: 14, borderWidth: 1, borderColor: "#E3E3E3", color: "#9A6201", fontSize: 21, fontWeight: "900" }, otpError: { borderColor: "#E45858" }, resend: { alignItems: "center", paddingVertical: 17 }, resendText: { color: "#9A6201", fontSize: 13, fontWeight: "900" }, resendDisabled: { color: "#667085" }, roleChoice: { marginTop: 17, padding: 15, minHeight: 103, borderRadius: 19, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#F5F5F5", flexDirection: "row", alignItems: "center", gap: 12 }, roleChoiceActive: { borderColor: "#9A6201", backgroundColor: "#F5F5F5" }, roleChoiceIcon: { width: 51, height: 51, borderRadius: 17, backgroundColor: "#F5F5F5", alignItems: "center", justifyContent: "center" }, roleChoiceIconActive: { backgroundColor: "#9A6201" }, roleChoiceInfo: { flex: 1 }, roleChoiceTitle: { color: "#1F1206", fontSize: 16, fontWeight: "900" }, roleChoiceText: { color: "#667085", fontSize: 12, lineHeight: 17, marginTop: 4 }, radio: { width: 22, height: 22, borderRadius: 11, borderWidth: 2, borderColor: "#F5F5F5", alignItems: "center", justifyContent: "center" }, radioActive: { borderColor: "#9A6201" }, radioInner: { width: 11, height: 11, borderRadius: 6, backgroundColor: "#9A6201" }, vehicleGrid: { flexDirection: "row", flexWrap: "wrap", gap: 10, marginTop: 22 }, vehicleCard: { width: "48.5%", minHeight: 130, borderRadius: 18, padding: 13, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#F5F5F5" }, vehicleCardActive: { backgroundColor: "#9A6201", borderColor: "#9A6201" }, vehicleTitle: { color: "#1F1206", fontSize: 15, fontWeight: "900", marginTop: 11 }, vehicleTitleActive: { color: "#FFFFFF" }, vehicleText: { color: "#667085", fontSize: 11, marginTop: 3 }, vehicleTextActive: { color: "#F5F5F5" }, vehicleCheck: { width: 20, height: 20, borderRadius: 10, borderWidth: 1.5, borderColor: "#F5F5F5", alignItems: "center", justifyContent: "center", position: "absolute", right: 10, top: 10 }, vehicleCheckActive: { backgroundColor: "#18A572", borderColor: "#18A572" }, nameInput: { minHeight: 58, paddingHorizontal: 15, borderRadius: 16, borderWidth: 1, borderColor: "#E3E3E3", backgroundColor: "#FFFFFF", color: "#9A6201", fontSize: 16, fontWeight: "800" }, referralToggle: { flexDirection: "row", alignItems: "center", gap: 7, marginTop: 20, alignSelf: "flex-start" }, referralToggleText: { color: "#9A6201", fontSize: 13, fontWeight: "800" }, lockedRole: { flexDirection: "row", alignItems: "flex-start", gap: 8, padding: 12, borderRadius: 14, backgroundColor: "#F5F5F5", marginTop: 18 }, lockedRoleText: { flex: 1, color: "#9A6201", fontSize: 12, lineHeight: 18 }, modal: { flex: 1, justifyContent: "flex-end" }, modalScrim: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(11,31,58,0.46)" }, countrySheet: { backgroundColor: "#FFFFFF", borderTopLeftRadius: 26, borderTopRightRadius: 26, padding: 20, paddingBottom: 30 }, sheetHandle: { width: 40, height: 4, borderRadius: 2, backgroundColor: "#F5F5F5", alignSelf: "center", marginBottom: 18 }, sheetTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }, sheetTitle: { color: "#1F1206", fontSize: 20, fontWeight: "900" }, sheetSubtitle: { color: "#667085", fontSize: 12, marginTop: 3 }, sheetClose: { width: 38, height: 38, borderRadius: 13, alignItems: "center", justifyContent: "center", backgroundColor: "#FFFFFF" }, countryRow: { minHeight: 58, flexDirection: "row", alignItems: "center", paddingHorizontal: 8, borderRadius: 15, marginTop: 4 }, countryRowActive: { backgroundColor: "#FFFFFF" }, pressed: { opacity: 0.68 },
});
...
const styles = StyleSheet.create({
  ...
  brandChip: { ...baseStyles.brandChip, borderRadius: 8, backgroundColor: "#FFFFFF", marginTop: 10 },
  ...
  languageSwitch: { ...baseStyles.languageSwitch, borderRadius: 9, backgroundColor: "#E3E3E3" },
