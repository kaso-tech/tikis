...
const styles = StyleSheet.create({
  ...
  brandChip: { ...baseStyles.brandChip, borderRadius: 8, backgroundColor: "#E2F3F4", marginTop: 10 },
  brandChipText: { ...baseStyles.brandChipText, fontWeight: "600" },
  welcomeBody: { ...baseStyles.welcomeBody, marginTop: 24 },
  welcomeEyebrow: { ...baseStyles.welcomeEyebrow, fontWeight: "600" },
  ...
  trustIcon: { ...baseStyles.trustIcon, borderRadius: 8, backgroundColor: "#EEEDF3" },
  trustTitle: { ...baseStyles.trustTitle, fontWeight: "600" },
  legalLink: { ...baseStyles.legalLink, fontWeight: "600" },
  top: { ...baseStyles.top, marginBottom: 18 },
  backButton: { ...baseStyles.backButton, borderRadius: 9, borderWidth: 0, backgroundColor: "#FFFFFF" },
  stepLabel: { ...baseStyles.stepLabel, fontWeight: "600" },
  stepCount: { ...baseStyles.stepCount, fontWeight: "600" },
  heroIcon: { ...baseStyles.heroIcon, borderRadius: 12, marginBottom: 16 },
  ...
  simulationNotice: { ...baseStyles.simulationNotice, borderRadius: 10, backgroundColor: "#E2F3F4", marginTop: 18 },
  simulationCode: { ...baseStyles.simulationCode, fontWeight: "600" },
  phoneHighlight: { ...baseStyles.phoneHighlight, fontWeight: "600" },
  otpRow: { ...baseStyles.otpRow, marginTop: 22 },
  otpInput: { ...baseStyles.otpInput, borderRadius: 9, fontWeight: "600" },
  resendText: { ...baseStyles.resendText, fontWeight: "600" },
  roleChoice: { ...baseStyles.roleChoice, borderRadius: 10, borderWidth: 0, marginTop: 12, padding: 13 },
  roleChoiceActive: { ...baseStyles.roleChoiceActive, borderWidth: 0, backgroundColor: "#E2F3F4" },
  roleChoiceIcon: { ...baseStyles.roleChoiceIcon, borderRadius: 10, backgroundColor: "#EEEDF3" },
  ...
  vehicleCardActive: { ...baseStyles.vehicleCardActive, borderWidth: 0 },
