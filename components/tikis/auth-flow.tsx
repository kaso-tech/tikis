...
const AUTH_DARK = { bg: "#171108", surface: "#231A10", input: "#171108", border: "#4A3823", text: "#FBF7F0", muted: "#C8BCAA", accent: "#01A7BD", chip: "#1F1206" };
...
function PhoneScreen({ country, value, error, loading, onCountryPress, onChange, onContinue, isDark }: { country: CountrySpec; value: string; error: string; loading: boolean; onCountryPress: () => void; onChange: (value: string) => void; onContinue: () => void; isDark: boolean }) {
  return <View style={styles.form}>
    <View style={[styles.heroIcon, isDark && { backgroundColor: AUTH_DARK.surface }]}><MaterialIcons name="smartphone" size={30} color={isDark ? AUTH_DARK.accent : "#01A7BD"} /></View>
...
function NameScreen({ role, phone, vehicles, value, error, loading, onChange, onContinue, onEditRole, onEditVehicles, referralCode, referralFieldOpen, onReferralFieldOpen, onReferralCodeChange, isDark }: { role: UserRole | null; phone: string; vehicles: VehicleType[]; value: string; error: string; loading: boolean; onChange: (value: string) => void; onContinue: () => void; onEditRole: () => void; onEditVehicles: () => void; referralCode: string; referralFieldOpen: boolean; onReferralFieldOpen: () => void; onReferralCodeChange: (value: string) => void; isDark: boolean }) {
  return <View style={styles.form}>
    <View style={[styles.heroIcon, isDark && { backgroundColor: AUTH_DARK.surface }]}><MaterialIcons name="badge" size={30} color={isDark ? AUTH_DARK.accent : "#01A7BD"} /></View>
...
const styles = StyleSheet.create({
  ...
  stepDotActive: { ...baseStyles.stepDotActive, backgroundColor: "#01A7BD" },
  ...
  roleChoiceActive: { ...baseStyles.roleChoiceActive, borderColor: "#01A7BD", borderWidth: 0, backgroundColor: "#FFFFFF" },
  roleChoiceIcon: { ...baseStyles.roleChoiceIcon, borderRadius: 10, backgroundColor: "#FFFFFF" },
  roleChoiceIconActive: { ...baseStyles.roleChoiceIconActive, backgroundColor: "#01A7BD" },
  radioActive: { ...baseStyles.radioActive, borderColor: "#01A7BD" },
  radioInner: { ...baseStyles.radioInner, backgroundColor: "#01A7BD" },
  ...
  vehicleCardActive: { ...baseStyles.vehicleCardActive, backgroundColor: "#01A7BD", borderWidth: 0 },
