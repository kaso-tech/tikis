...
const styles = StyleSheet.create({ wrap: { marginBottom: 12 }, label: { color: "#444444", fontWeight: "600", fontSize: 12, marginBottom: 6 }, card: { padding: 10 }, searchRow: { flexDirection: "row", alignItems: "center", minHeight: 44, borderWidth: 1, borderColor: "#E5D2B9", borderRadius: 9, backgroundColor: "#F7EFE5", paddingLeft: 10, gap: 7 }, input: { flex: 1, minHeight: 42, color: "#9A6201", fontSize: 13, fontWeight: "500" }, nearbyButton: { width: 32, height: 32, borderRadius: 7, borderWidth: 1, borderColor: "#E5D2B9", alignItems: "center", justifyContent: "center", backgroundColor: "#F7EFE5" }, searchButton: { width: 36, alignSelf: "stretch", borderRadius: 8, borderWidth: 1, borderColor: "#E5D2B9", backgroundColor: "#F7EFE5", alignItems: "center", justifyContent: "center" }, currentLocationButton: { minHeight: 40, marginTop: 9, borderRadius: 8, borderWidth: 1, borderColor: "#E5D2B9", backgroundColor: "#F7EFE5", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, paddingHorizontal: 11 }, currentLocationText: { color: "#9A6201", fontSize: 12, fontWeight: "600" }, mapWrap: { overflow: "hidden", borderRadius: 9, height: 160, marginTop: 9, backgroundColor: "#F5F5F5" }, map: { width: "100%", height: "100%" }, mapHint: { position: "absolute", bottom: 8, alignSelf: "center", flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: "rgba(0,0,0,0.7)", paddingHorizontal: 9, paddingVertical: 5, borderRadius: 7 }, mapHintText: { color: "#FFFFFF", fontSize: 10, fontWeight: "600" }, result: { flexDirection: "row", alignItems: "center", gap: 7, paddingVertical: 9, borderBottomWidth: 0 }, resultText: { flex: 1 }, resultName: { color: "#111111", fontSize: 13, fontWeight: "600" }, resultMeta: { color: "#666666", fontSize: 11, marginTop: 2 }, attribution: { color: "#666666", fontSize: 9, marginTop: 6 }, selected: { backgroundColor: "#F7EFE5", borderWidth: 1, borderColor: "#E5D2B9", borderRadius: 9, padding: 9, flexDirection: "row", alignItems: "center", gap: 6, marginTop: 9 }, selectedText: { flex: 1, color: "#167A55", fontSize: 12, fontWeight: "600" }, message: { color: "#9A6200", fontSize: 11, lineHeight: 16, marginTop: 6 }, pressed: { opacity: 0.67 } });
