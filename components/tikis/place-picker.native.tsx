...
const styles = StyleSheet.create({ wrap: { marginBottom: 15 }, label: { color: "#485569", fontWeight: "800", fontSize: 13, marginBottom: 7 }, card: { padding: 10 }, searchRow: { flexDirection: "row", alignItems: "center", minHeight: 48, borderWidth: 1, borderColor: "#DDE5ED", borderRadius: 14, paddingLeft: 11, gap: 8 }, input: { flex: 1, minHeight: 46, color: "#0B1F3A", fontSize: 13, fontWeight: "600" }, nearbyButton: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: "#E6F5F6" }, searchButton: { width: 40, alignSelf: "stretch", borderRadius: 13, alignItems: "center", justifyContent: "center" }, currentLocationButton: { minHeight: 44, marginTop: 10, borderRadius: 12, backgroundColor: "#E6F5F6", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingHorizontal: 12 }, currentLocationText: { color: "#007B8B", fontSize: 12, fontWeight: "900" }, mapWrap: { overflow: "hidden", borderRadius: 14, height: 180, marginTop: 10, backgroundColor: "#EAF1F6" }, map: { width: "100%", height: "100%" }, mapHint: { position: "absolute", bottom: 9, alignSelf: "center", flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "rgba(11,31,58,0.82)", paddingHorizontal: 10, paddingVertical: 6, borderRadius: 12 }, mapHintText: { color: "#FFFFFF", fontSize: 10, fontWeight: "800" }, result: { flexDirection: "row", alignItems: "center", gap: 8, paddingVertical: 11, borderBottomWidth: 1, borderColor: "#EEF2F6" }, resultText: { flex: 1 }, resultName: { color: "#0B1F3A", fontSize: 13, fontWeight: "800" }, resultMeta: { color: "#78869A", fontSize: 11, marginTop: 2 }, attribution: { color: "#78869A", fontSize: 9, marginTop: 7 }, selected: { backgroundColor: "#EAF8F1", borderRadius: 12, padding: 10, flexDirection: "row", alignItems: "center", gap: 7, marginTop: 10 }, selectedText: { flex: 1, color: "#147A58", fontSize: 12, fontWeight: "800" }, message: { color: "#B45309", fontSize: 11, lineHeight: 16, marginTop: 8 }, pressed: { opacity: 0.68 } });
