...
const styles = StyleSheet.create({
  container: { flex: 1, overflow: "hidden", backgroundColor: "#F5F5F5", position: "relative" }, grid: { ...StyleSheet.absoluteFillObject, opacity: 0.28, backgroundColor: "#F5F5F5" }, route: { position: "absolute", height: 6, borderRadius: 4, backgroundColor: "#9A6201", width: "65%", top: "51%", left: "17%", transform: [{ rotate: "-17deg" }] }, routeFallback: { backgroundColor: "#9A6200", opacity: 0.85, borderStyle: "dashed" }, start: { position: "absolute", left: "15%", top: "62%", width: 30, height: 30, borderRadius: 7, backgroundColor: "#9A6201", alignItems: "center", justifyContent: "center", borderWidth: 0 }, destination: { position: "absolute", right: "15%", top: "31%", width: 32, height: 32, borderRadius: 8, backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center" }, driver: { position: "absolute", left: "48%", top: "45%", width: 30, height: 30, borderRadius: 15, backgroundColor: "#007B8B", alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: "#FFFFFF" }, webNote: { position: "absolute", left: 14, right: 14, bottom: 14, padding: 11, borderRadius: 9, backgroundColor: "rgba(255,255,255,0.94)", flexDirection: "row", gap: 7, alignItems: "center" }, webNoteText: { color: "#666666", fontSize: 12, fontWeight: "500", flex: 1, lineHeight: 17 },
});
